...
import hearticon from '../../public/Whislist Icon.svg'
  ...
  return (
    <div className='w-full md:h-lvh sm:h-full md:px-[150px] sm:px-[25px] py-[76px] flex md:flex-row sm:flex-col  space-x-20'>
        ...
        <div className='space-y-6'>
            ...
            <div className='w-full border-b-[#757575] border'></div>
            <button className='bg-bluesecond w-[334px] h-[60px] rounded-full text-white font-Inter flex items-center justify-center'>Member Checkout</button>
        </div>
        </div>

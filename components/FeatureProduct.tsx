  ...
  return (
    <div className="w-full md:h-[410px] sm:h-full bg-white space-y-16">
      <div className="flex items-center justify-between ">
        <h1 className="text-black text-3xl tracking-[0.2em]">
          FEATURED PRODUCTS
        </h1>
        <h1 className="text-black text-lg underline decoration-black">
          View all
        </h1>
      </div>
      <div className="grid md:grid-cols-5 sm:grid-cols-1 gap-8">
        <div className="flex flex-col space-y-5">
          <Image src={i1} alt="image" width={263} height={306} />
          <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col space-y-5">
          <Image src={i2} alt="image" width={263} height={306} />
          <div className="flex items-center justify-between">
            <h3 className="text-secondary">Library Stool Chair</h3>
            <h1 className="text-black text-sm ">$99</h1>
          </div>
        ...
        <div className="flex flex-col space-y-5">
          <Image src={i3} alt="image" width={263} height={306} />
          <div className="flex items-center justify-between">
            <h3 className="text-secondary">Library Stool Chair</h3>
            <h1 className="text-black text-sm ">$99</h1>
          </div>
        ...
        <div className="flex flex-col space-y-5">
          <Image src={i4} alt="image" width={263} height={306} />
          <div className="flex items-center justify-between">
            <h3 className="text-secondary">Library Stool Chair</h3>
            <h1 className="text-black text-sm ">$99</h1>
          </div>
        ...
        <div className="flex flex-col space-y-5">
          <Image src={i5} alt="image" width={263} height={306} />
          <div className="flex items-center justify-between">
            <h3 className="text-secondary">Library Stool Chair</h3>
            <h1 className="text-black text-sm ">$99</h1>
          </div>
